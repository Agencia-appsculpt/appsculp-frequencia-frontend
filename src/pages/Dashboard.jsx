...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6 px-2 sm:px-4 md:px-6 lg:px-8 max-w-full">
      {/* Welcome Section */}
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {quickActions.map((action, index) => (
              <div
                key={index}
                className="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 rounded-lg shadow hover:shadow-md transition-shadow w-full"
              >
                <div>
